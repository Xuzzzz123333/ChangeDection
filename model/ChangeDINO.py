...
class Encoder(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.dino = DINOV3Wrapper(
            ...
            local_conv_change_delta_mode=kwargs.get(
                "dino_local_conv_change_delta_mode", "antisymmetric"
            ),
            ...
            use_dynamic_policy=kwargs.get("use_dynamic_policy", False),
            use_head_policy=kwargs.get("use_head_policy", False),
            use_block_policy=kwargs.get("use_block_policy", False),
            block_policy_mode=kwargs.get("block_policy_mode", "record_only"),
            use_token_policy=kwargs.get("use_token_policy", False),
            use_mlp_policy=kwargs.get("use_mlp_policy", False),
            mlp_num_chunks=kwargs.get("mlp_num_chunks", 4),
            mlp_policy_scope=kwargs.get("mlp_policy_scope", "batch_shared"),
            policy_mode=kwargs.get("policy_mode", "soft"),
            policy_hard=kwargs.get("policy_hard", False),
            ...
            policy_anneal_epochs=kwargs.get("policy_anneal_epochs", 5),
            ...
            policy_block_weight=kwargs.get("policy_block_weight", 0.0),
            policy_token_weight=kwargs.get("policy_token_weight", 0.0),
            policy_mlp_weight=kwargs.get("policy_mlp_weight", 0.0),
    ...
    def forward_dense_pair(self, x1, x2):
        if (
            ...
            and (
                getattr(self.dino, "local_conv_change_aware_enable", False)
                or getattr(self.dino, "use_dynamic_policy", False)
            )
        ):
